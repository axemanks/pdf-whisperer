    ...
    <>
      ...
      <div>
        <div className='relative isolate'>
          ...
          <div>
            <div className='mx-auto max-w-6xl pl-6 lg:px-8'>
              <div className='mt-16 flow-root sm:mt-24'>
                <div className='-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4'>
                  <Image
                    className='rounded-md bg-white p-2 sm:p-8 md:p-20 shadow-2xl ring-1 ring-gray-900/10'
                    alt='PDF-Whisperer Preview'
      ...
      <div className='mx-auto mb-32 mt-32 max-w-5xl sm:mt-56'>
        <div className='mb-12 px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl sm:text-center'>
              ...
              <p className='mt-4 text-lg text-gray-600'>Chatting to your PDF files has never been easier than with <span className='text-blue-600'>The PDF Whisperer</span>.</p>
          </div>
        </div>
        {/* Steps */}
        <ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>Either start with a free plan or choose our {' '}
              <Link 
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>It&apos;s that simple. Try out The PDF Whisperer today - it really takes less than a minute. Get started for free!</span>
            </div>
          </li>
        </ol>
